...
Si rien dans votre bibliothèque ne convient, l'IA peut esquisser un nouveau workflow à la volée. Elle propose un brouillon — une séquence d'étapes conçue pour ce que vous avez demandé — et l'exécute. Après l'exécution, le brouillon arrive dans votre bibliothèque sous **Brouillons**, où vous pouvez le conserver, le modifier dans le constructeur ou l'écarter.
