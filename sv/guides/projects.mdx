...
- **Beskrivning** — en kort anteckning som visas på projektkortet, användbart när du har många projekt. Klicka på **Generera med AI** om du vill att Saga ska skriva den utifrån projektnamnet.
- **Standardassistent** — den AI-modell eller anpassade assistent som öppnas som standard för nya chattar i projektet
- **Taggar** — etiketter på projektkortet och i listfiltren
- **Förfallodatum** — ett valfritt datum på kortet så att kommande arbete syns
...
På sidan **Projekt** använder du **Sortera** och **Filtrera** för att hitta ett projekt efter tagg, förfallodatum, status eller personer. Arkiverade projekt ligger utanför standardlistan tills du tar med dem i filtret.
