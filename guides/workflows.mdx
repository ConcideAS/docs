...
If nothing in your library fits, the AI can sketch a new workflow on the fly. It proposes a draft — a sequence of steps designed for what you asked — and runs it. After the run, the draft lands in your library under **Drafts**, where you can keep it, edit it in the builder, or discard it.
