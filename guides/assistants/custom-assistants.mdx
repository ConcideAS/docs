...
Admins can also attach instruction documents to a custom assistant. Saga includes the extracted text in the assistant's instructions, which is useful for playbooks, house style notes, or a clause list that should stay with the assistant rather than being re-attached in every chat.
