...
You can dictate messages instead of typing them. Click the **microphone** button in the chat input area to start recording. As you speak, your words are transcribed in real time and inserted into the message field — you can review and edit the text before sending.

While recording, a waveform visualizer and timer show that Saga is listening. Click **Stop** to finish recording and keep the transcribed text, or **Cancel** to discard it. Recording automatically stops after 30 minutes.

Speech to text uses your current interface language for transcription. It supports Danish, Dutch, English, French, German, Italian, Norwegian, Polish, Portuguese, Spanish, Swedish, and Turkish. If your interface language isn't supported, it defaults to English.

<Note>
Speech to text is not available in zero data retention chats.
</Note>
