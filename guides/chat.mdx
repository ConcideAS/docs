...
If you run into an issue while working in a chat, you can ask the assistant to submit a support ticket for you. Describe the problem in your message — for example, "I can't upload a file, can you open a support ticket?" — and the assistant will gather the details, summarize the issue, and ask you to confirm before submitting.

Once confirmed, the assistant creates the ticket and shows a reference ID you can use to follow up. The support team receives the ticket by email and will respond to you directly.

The assistant assigns a priority (low, medium, or high) based on the severity of the issue. You can also tell it explicitly — for example, "this is blocking my work" to indicate high priority.

<Tip>
You can still reach support by clicking **Get help** in the sidebar or emailing [support@sagalegal.io](mailto:support@sagalegal.io). The in-chat option is a shortcut when you're already in a conversation and want to report something without switching context.
</Tip>
