...
If your admin has enabled zero data retention, your conversations are not stored. Messages exist only in your browser session and are cleared when you leave or refresh the page. A banner at the top of the chat confirms this mode is active. See [Zero data retention](/guides/chat/zero-data-retention) for details.
