...
When [auto drafting](/guides/chat/context-and-sources#auto-drafting) is enabled and the AI generates a document — such as a memo, summary, or contract clause — it appears as a chip below the response. Click the chip to open the document in the side panel. Hover over it and click the download icon to export it as a Word file.
