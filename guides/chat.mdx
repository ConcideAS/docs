...
Models with adaptive reasoning, like Claude 4.7 Opus, automatically adjust how deeply they think based on what you're asking. Simple questions get fast answers, while complex analysis triggers more thorough reasoning. See [Models](/guides/assistants/models#adaptive-reasoning) for details.
