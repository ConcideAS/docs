...
You can dictate messages instead of typing them. Click the **microphone** button in the chat input to start recording. Speak naturally — Saga transcribes your audio and inserts the text into the message box when you're done.

Click **Transcribe** to stop recording and convert your speech to text, or **Cancel** to discard the recording. The transcribed text appears in the input field where you can review and edit it before sending.

Recordings can be up to 30 minutes long. If your browser doesn't support voice input or can't access your microphone, Saga shows a notification explaining what to do.

<Note>
Voice input requires microphone access in your browser. If you see a "Microphone access denied" message, check your browser's site permissions.
</Note>
