...
## Organize chats with projects

You can move any standalone chat into a project, move it to a different project, or remove it from a project entirely. This is useful when a conversation evolves beyond its original scope — for example, when exploratory research turns into work on a specific matter.

### Add a chat to a project

Open the chat and click the folder icon in the chat header. Select the project you want to add the chat to, then click **Add to Project** to confirm. The chat moves into the project and gains access to that project's knowledge base.

If you change your mind, an undo option appears briefly in the confirmation toast.

### Move a chat to a different project

If a chat is already in a project, open the **...** menu in the chat header and select **Change project**. Choose the target project and confirm. The chat transfers directly — the conversation history and all messages are preserved.

### Remove a chat from a project

Open the **...** menu in the chat header and select **Remove from project**. The chat returns to your standalone chat history and no longer has access to the project's knowledge base.
