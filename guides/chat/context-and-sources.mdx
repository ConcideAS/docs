...
Deep research goes beyond a single search. When you enable it from the **Add sources** menu, the AI conducts a comprehensive, multi-source web analysis — running multiple searches, synthesizing findings across sources, and producing a detailed report. This is useful for broad questions that benefit from wide-ranging research rather than a targeted lookup.

The report appears as a downloadable document in the chat. Deep research typically takes between 30 seconds and two minutes depending on the complexity of the query.
