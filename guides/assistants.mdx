...
- **Auto** — lets Saga automatically select the best model for each message based on task complexity. Appears as the first option in the selector. See [Auto mode](/guides/assistants/models#auto-mode) for details.
