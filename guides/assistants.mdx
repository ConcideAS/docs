...
The assistant selector appears at the bottom of the chat input. Click it to open a panel with three categories:

- **Auto** — Saga automatically selects the best model for each message based on complexity, balancing cost and intelligence. This is the default selection. See [Auto mode](/guides/assistants/models#auto-mode) for details.
