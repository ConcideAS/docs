...
**Admin de conta** — Gere apenas faturação e utilizadores. Os admins de conta podem abrir o painel de administração para essas tarefas, mas não podem usar funcionalidades do produto como chat, projetos, revisão em grelha, investigação jurídica, fluxos de trabalho ou os suplementos do Word e do Outlook. Esta função não consome um lugar de produto pago.
