...
Pode organizar a sua base de conhecimento com pastas e etiquetas com código de cores.
...
As **etiquetas** podem ser atribuídas tanto a documentos como a pastas. Dê a cada etiqueta um nome e uma cor, e use o filtro de etiquetas para mostrar apenas os itens com essa etiqueta. Para gerir as etiquetas de uma pasta, abra o seu menu de ações e selecione **Gerir etiquetas**. As etiquetas são úteis para marcar tipos de documento, estado de revisão ou qualquer outra coisa que atravesse a sua estrutura de pastas.

Quando usa o filtro de etiquetas, a base de conhecimento mostra todos os documentos e pastas que correspondem — incluindo pastas cujas etiquetas correspondem mesmo que os documentos dentro delas não correspondam.

### Etiquetas no contexto da IA

O Saga inclui informações de etiquetas ao construir o contexto para a IA. Quando faz uma pergunta no chat, a IA vê quais etiquetas estão atribuídas a cada documento e pasta. Isto ajuda a IA a compreender como os seus ficheiros estão categorizados e pode melhorar a relevância das respostas.
