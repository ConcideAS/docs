...
Os administradores podem ver todos no espaço de trabalho, alterar papéis, remover utilizadores, reativar contas eliminadas e desativar a autenticação de dois fatores para utilizadores que perderam o acesso.

Cada linha de utilizador mostra quando a conta foi criada, facilitando o acompanhamento dos prazos de integração. Pode também exportar a lista completa de utilizadores para Excel — incluindo datas de criação e métricas de utilização.
