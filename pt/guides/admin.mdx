...
- **Assistente predefinido** — o assistente de IA que é pré-selecionado para novas conversas. Note que os modelos Claude Opus não podem ser definidos como predefinição do espaço de trabalho; permanecem disponíveis para seleção durante conversas individuais.
