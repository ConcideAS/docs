...
Nos espaços de trabalho Saga Solo, cada utilizador licenciado tem um **Saga ID** — um identificador numérico que o associa à sua subscrição. Pode gerir os Saga ID de duas formas:

- **Ao adicionar um utilizador** — introduza o Saga ID na caixa de diálogo de adição de utilizador. Nos espaços de trabalho Saga Solo, este campo é obrigatório.
- **Num utilizador existente** — clique em **Editar** junto ao Saga ID atual na tabela de utilizadores, introduza o novo valor e clique em **Guardar**.

Os Saga ID podem conter apenas números e ter no máximo 20 dígitos. São também incluídos ao exportar a lista de utilizadores para Excel.
