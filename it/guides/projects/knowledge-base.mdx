...
Le **cartelle** ti permettono di replicare la tua struttura di file esistente. Crea cartelle nidificate, trascina i documenti tra di esse e scarica un'intera cartella come ZIP quando hai bisogno di condividere file al di fuori di Saga.
...
Quando rinomini, sposti o elimini un documento o una cartella, Saga mostra una breve notifica con un pulsante **Annulla**. Cliccalo per annullare immediatamente l'azione.

Le eliminazioni utilizzano una cancellazione temporanea — l'elemento viene rimosso dalla vista ma non viene eliminato permanentemente subito. Se clicchi **Annulla** entro pochi secondi, il documento o la cartella viene completamente ripristinato con tutto il suo contenuto. Una volta che la finestra di annullamento si chiude, l'eliminazione diventa permanente.
