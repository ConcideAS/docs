...
Se nulla nella tua libreria è adatto, l'IA può abbozzare al volo un nuovo flusso di lavoro. Propone una bozza — una sequenza di passaggi pensata per ciò che hai chiesto — e la esegue. Dopo l'esecuzione, la bozza atterra nella tua libreria sotto **Bozze**, dove puoi conservarla, modificarla nel costruttore o scartarla.
