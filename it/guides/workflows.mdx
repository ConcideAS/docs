...
| **Deep Web Research** | Esegue un'analisi approfondita multi-fonte sul web e restituisce un report con citazioni (vedi [Deep web research](/it/guides/chat/deep-research)) |
...
## Flussi di lavoro in chat

Puoi eseguire i flussi di lavoro direttamente da una chat senza aprire il costruttore. Chiedi all'IA di gestire un'attività multi-step e cercherà nella tua libreria un flusso di lavoro corrispondente, eseguendolo inline — mettendosi in pausa per gli input nello stesso modo in cui farebbe nel costruttore e mostrando ogni passaggio nel thread della chat man mano che procede.

Se nulla nella tua libreria è adatto, l'IA può abbozzare al volo un nuovo flusso di lavoro. Propone una bozza — una sequenza di passaggi pensata per ciò che hai chiesto — e la esegue. Dopo l'esecuzione, la bozza atterra nella tua libreria sotto **Personale**, dove puoi conservarla, modificarla nel costruttore o scartarla.

Questo significa che puoi chiedere qualcosa come "traduci questi contratti in inglese, riassumi ciascuno e segnala le clausole insolite" e lasciare che Saga costruisca ed esegua il flusso giusto senza che tu disponga il canvas autonomamente.
